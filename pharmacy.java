...
public class pharmacy extends JPanel{
	...
	public void addComponentToPanel(){
		this.btn3 = new JButton("Medicine Corner");
		this.btn3.setBounds(200, 250, 200, 30);
		this.add(btn3);
	 MyLis lis2 = new MyLis();
	this.btn3.addActionListener(lis2);
	...
	btn3.addActionListener( new ActionListener(){
		...
		JButton btn1=new JButton("SHOW All Medicine");
		
		JLabel lbl=new JLabel("SERIAL               :");
		JLabel lbl1=new JLabel("NAME                :");
		JLabel lbl2=new JLabel("COMPANY             :");
		JLabel lbl3=new JLabel("GROUP               :");
	   ...
	   Statement stmt = con.createStatement();
        ...
        String sql="INSERT INTO `medicine`(`serial`, `name`, `company`,`group`,`price`) VALUES ("+value0+","+"'"+value1+"',"+"'"+value2+"',"+"'"+value3+"',"+"'"+value4+"')";
	...
	btn1.addActionListener( new ActionListener(){
		 ...
		 String [] columns = new String [] {"serial", "name","company","group", "price"};
	   ...
	   ResultSet rs = stmt.executeQuery("select * from medicine`");
			...
			while (rs.next()) {
				...
				data[i][j++] = rs.getString("serial");
				data[i][j++] = rs.getString("name");
				data[i][j++] = rs.getString("company");
				data[i][j++] = rs.getString("group");
